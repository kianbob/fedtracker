...
export const metadata: Metadata = {
  title: "Monthly Federal Workforce Changes FY2020-2024",
  description:
  ...
  alternates: { canonical: "/monthly-timeline" },
};
    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            { href: "/trends", title: "Workforce Trends", desc: "Historical patterns in federal employment" },
            { href: "/timeline", title: "Event Timeline", desc: "Key events affecting the federal workforce" },
