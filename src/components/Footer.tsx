          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <a href="https://permitcore.io" target="_blank" rel="noopener noreferrer" className="block text-gray-600 hover:text-accent">PermitCore — Construction Permit Intelligence ↗</a>
                <a href="https://americanfactbook.org" target="_blank" rel="noopener noreferrer" className="block text-gray-600 hover:text-accent">American Factbook ↗</a>
